...
export class Inventory {
    ...
    constructor() {
        ...
        this.altActive = new ActiveSlot(new Position(GAMEWIDTH - 20, 90), activeDict.locked, true);
        this.bagSlots = [];
        for (let i = 0; i < 36; i++) {
            this.bagSlots.push(new Slot(new Position(BORDERTHICKLEFT + 13 + 18 * (i % 6), BORDERTHICKTOP + 13 + 18 * Math.floor(i / 6))));
        }
