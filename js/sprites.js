...
const sprites = {
  ...
  block_dirt_hidden: new Sprite("./images/block_dirt_hidden.png"),
  block_dirt_unknown: new Sprite("./images/block_dirt_unknown.png"),
  block_empty: new Sprite("./images/block_empty.png"),
  block_gold_ore: new Sprite("./images/block_gold_ore.png"),
  ...
  door_exit_open: new Sprite("./images/door_exit_open.png"),
  door_exit: new Sprite("./images/door_exit.png"),
  ...
  numbers_ground: new Sprite("./images/numbers_ground.png"),
  ...
  door_shop_open: new Sprite("./images/door_shop_open.png"),
  door_shop: new Sprite("./images/door_shop.png"),
