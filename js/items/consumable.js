...
time_potion.render = (canvasManager) => {
    ...
    if (time_potion.mouseHovering) {
        canvasManager.renderSpriteFromSheet(sprites.item_sheet, time_potion.pos, 16, 16, time_potion.spriteSheetPos.add(1, 0));
    }
    canvasManager.renderAnimationFrame(sprites.time_potion_pointer_sheet, consumableDic.time_potion.pos, 16, 16, 12, 1, consumableDic.time_potion.firstAnimationTic, timeTracker.currentGameTic);
    canvasManager.renderAnimationFrame(sprites.time_potion_pointer_sheet, consumableDic.time_potion.pos, 16, 16, 12, 1, consumableDic.time_potion.firstAnimationTic, timeTracker.currentGameTic, 1 / 12, new Position(0, 1));
};
