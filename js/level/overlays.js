...
stunnedOverlay.render = () => {
    ...
    canvasManager.renderAnimationFrame(stunnedOverlay.sprite, stunnedOverlay.pos, stunnedOverlay.width, stunnedOverlay.height, 4, 1, stunnedOverlay.animationTicStart, Math.floor((100 - gameState.stunnedTimer.percentage) / 25), new Position(), false);
};
