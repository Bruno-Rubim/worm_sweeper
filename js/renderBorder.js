...
import { BORDERTHICKBOTTOM, BORDERTHICKLEFT, GAMEHEIGHT, GAMEWIDTH, } from "./global.js";
...
function renderStats(canvasManager, gameState) {
    ...
    canvasManager.renderText("numbers_red", new Position(GAMEWIDTH - 20, GAMEHEIGHT - 14), "$run" + gameState.deathCount.toString());
    canvasManager.renderText("numbers_gold", new Position(GAMEWIDTH - 29, 6), "$gld " + gameState.gold.toString());
